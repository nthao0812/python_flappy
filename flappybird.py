...
sand_img=pygame.transform.scale(sand_img,(400,300))
tube1_pass=False
tube2_pass=False
tube3_pass=False
pausing=False
...
while running:
	...
	tube2_op = screen.blit(tube1_op_img, (tube2_x, tube2_height + d_2tube))
	...
	#xử lý va chạm ống và game over
